...
--
-- Host: 127.0.0.1
-- Generation Time: 2015-03-26 10:13:20
-- 服务器版本： 5.6.21
-- PHP Version: 5.6.3
...
CREATE TABLE IF NOT EXISTS `of_applicationdetail` (
  ...
  `sId` int(8) NOT NULL COMMENT '服务ID',
...
(1, 'XQ', 'e10adc3949ba59abbe56e057f20f883e', '', 'xqnssa@qq.com', 0, 0, 1427287068, '', 0),
(2, 'xqnssa', '12e83b7076695d26a869500e1de9f257', '', 'xqnssa@163.com', 0, 0, 1427287068, '', 0),
(3, '123', 'e10adc3949ba59abbe56e057f20f883e', '', 'xq@q.com', 0, 0, 1427287068, '', 0),
(4, '我要去留学啊', '96e79218965eb72c92a549dd5a330112', '', 'test@qq.com', 0, 0, 1427287068, '', 0),
(5, '手机测试注册', '96e79218965eb72c92a549dd5a330112', '', 'mobile@qq.com', 0, 0, 1427287068, '', 0),
(6, '我要去留学啊啊', '96e79218965eb72c92a549dd5a330112', '', 'test@163.com', 0, 0, 1427287068, '', 0);
...
--
ALTER TABLE `of_application`
MODIFY `aId` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增ID';
--
