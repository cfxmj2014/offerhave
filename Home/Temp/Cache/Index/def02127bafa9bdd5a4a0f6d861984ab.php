...
<div class="consultant-banner">  
	<div class="cst-tag for-header">
	  <div class="container">
	  	<div class="row">
	  		<div class="col-md-12">
	    		<img src="<?php echo ($cstInfo["image"]); ?>" class="img-circle cst-photo">
			    <div class="cst-info-list"> 
			      <h3><?php echo ($cstInfo["cstName"]); ?> <img src="__PUBLIC__/images/p-1.png" width="30px" height="30px"></h3>
			      <p><?php echo ($cstInfo["sName"]); ?>，<?php echo ($cstInfo["cstMajor"]); ?> · <?php echo ($cstInfo["cstType"]); ?></p>
			      <div class="verify-info">
			        <img src="__PUBLIC__/images/p-2.png"><span>&nbsp;线下身份 </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			        <img src="__PUBLIC__/images/p-2.png"><span>&nbsp;文书水平</span>
			      </div>
			      <div class="book-info">
				      <div class="info-price">
				        <h4>个人陈述文书价格</h4>
				        <h3>CNY <span class="base-color"><?php echo ($first["price"]); ?></span></h3>
				      </div>
					  <div class="to-book" id="<?php echo ($cstId=$cstInfo["cstId"]); ?>">
					  	<a href="<?php echo U('Index/Application/index',array("cstId"=>$cstId),"");?>">
...
<div class="bg-dark-gray">
  <div class="container">
    <div class="panel panel-default panel-cst">
      <div class="panel-heading">关于我</div>
      <div class="panel-body">
        <h3>Hi there! I am <?php echo ($cstInfo["cstName"]); ?></h3>
        <h6>学校: <?php echo ($cstInfo["sName"]); ?></h6>
        <h6>专业：<?php echo ($cstInfo["cstMajor"]); ?></h6>
        <h6>达人类型：<?php echo ($cstInfo["cstType"]); ?></h6>
        <h6>语言沟通能力：<?php echo ($cstInfo["language"]); ?></h6>
        <p><?php echo ($cstInfo["introduction"]); ?></p>
      </div>
    </div>
    <div class="panel panel-default panel-cst">
      <div class="panel-heading">我提供的服务</div>
        <ul class="list-group">
        	<?php if(is_array($serviceInfo)): foreach($serviceInfo as $key=>$v): ?><li class="list-group-item">
				  <div class="container">                  
					<div class="row">
					  <div class="col-md-4 service-img">
						<img src="<?php echo ($v["sImage"]); ?>" width="40px" height="40px">
					  </div>
					  <div class="col-md-4 service-title">
						<h3><?php echo ($v["sName"]); ?></h3>
						<small><?php echo ($v["sInfo"]); ?></small>
					  </div>
					  <div class="col-md-4 service-price">
						<h3>CNY <span class="base-color"><?php echo ($v["price"]); ?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="m-tag"><?php echo ($v["sTag"]); ?></span></h3>
						<p><?php echo ($v["sTag"]); ?></p>
					  </div>                
					</div>
				  </div>
