...
<div class="for-header user-items">
  <div class="container">
    <ul>
      <li class="items-active"><a href="<?php echo U('/Index/User/Application','','');?>"><span class="font-color-white">Application</span></a></li>
        ...
        <div class="panel panel-default panel-app">
          <div class="panel-heading">
            <!--<select style=" width: 140px; height: 35px;">
              <option>All</option>
              <option>Already dealt</option>
              <option>Not deal yet</option>	
            </select>-->
            Sent Application
          </div>
