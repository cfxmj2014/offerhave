...
<div class="for-header user-items">
  <div class="container">
    <ul>
      ...
      <li class="items-active"><a href="<?php echo U('/Index/User/Wishlist','','');?>"><span class="font-color-white">Wishlist</span></a></li>
  ...
  <div class="container">
    <div class="row user-row">
      ...
      <div class="col-md-9 wish-list">
        <p>Your wishlist is empty. Click 'hear button' to add into your wishlist.</p>
      </div>
    </div>
    <hr class="hr-style">
    <div class="row user-row">
