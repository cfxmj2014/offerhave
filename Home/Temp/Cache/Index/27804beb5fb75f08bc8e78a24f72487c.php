...
<div class="for-header user-items">
  <div class="container">
    <ul>
      ...
      <li class="items-active"><a href="<?php echo U('/Index/User/Resume','','');?>"><span class="font-color-white">Resume</span></a></li>
      <li><a href="<?php echo U('/Index/User/Wishlist','','');?>">Wishlist</a></li>
      <li><a href="<?php echo U('/Index/User/Settings','','');?>">Settings</a></li>
    </ul>
  </div>
</div>
<!-- 个人信息 -->
<div class="bg-light-gray">
  <div class="container">
      ...
      <div class="col-md-9">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <form>
              <div class="info-list">
                <p>Please upload one clear photo of yours. Any logo or name of your university will be much appreciated and welcomed to be showed in the photo.</p>
    ...
    <div class="row user-row">
      ...
      <div class="col-md-9">
        <div class="panel panel-default">
          <div class="panel-heading">Identity Documents</div>
          <div class="panel-body">
            <form>
              <div class="info-list">
  ...
  <div class="container">
    <center>
      <a href="#"><button type="button" class="btn form-control be-cst-bt">SUBMIT</button></a> 
    </center>
  </div>
</div>
