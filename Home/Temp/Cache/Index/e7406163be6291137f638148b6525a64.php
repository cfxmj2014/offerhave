...
<!-- title -->
<div class="l-title for-header">
  <div class="container">      
    <div class="row">
      <center>
        <h1><b>梦想，从有offer开始。</b></h1>
        <h2>我们拒绝<span class="base-color">院校佣金</span>，只为给你<span class="base-color">更好的未来</span>。</h2>
      </center>
    </div>          
  </div>
</div>
<!-- 定位学校 -->
<div class="bg-light-gray l-school">
  <div class="container">
    <h3><b>你的名校方案</b></h3>
    <hr class="hr-style">
    <div class="table-responsive">
      <table class="table location-table">
        ...
        <tbody>
        <?php if(is_array($School["Recommend"])): foreach($School["Recommend"] as $key=>$v): ?><tr>
            <td  name=<?php echo ($school=$v["sName"]); ?>>
              <a href="<?php echo U("Index/School/index",array("school"=>$school,"major"=>"all"),"");?>" target="_blank" class="location-school">
                <img src="<?php echo ($v["image"]); ?>" class="s-img">
                <span class="s-name"><?php echo ($v["sName"]); ?></span>
              </a>
            </td>
            <td><span class="base-color"><?php echo ($v["Wsort"]); ?></span>（QS）／<span class="base-color"><?php echo ($v["Csort"]); ?></span>（上海交大版）</td>
            <td><span class="base-color"><?php echo ($v["Esort"]); ?></span>（QS）</td>
  ...
  <div class="container">
    ...
    <div class="table-responsive">
      <table class="table location-table">
        <tbody>
        <?php if(is_array($School["Safe"])): foreach($School["Safe"] as $key=>$v): ?><tr>
            <td name=<?php echo ($school=$v["sName"]); ?>>
              <a href="<?php echo U("Index/School/index",array("school"=>$school,"major"=>"all"),"");?>" target="_blank" class="location-school">
                <img src="<?php echo ($v["image"]); ?>" class="s-img">
                <span class="s-name"><?php echo ($v["sName"]); ?></span>
...
<div class="bg-dark-gray"><br>
  <div class="container">
    <div class="title">看看这些名校的申请达人</div><br>
    <div class="row" cstId=<?php echo ($cstId=$v["cstId"]); ?>>
      <?php if(is_array($cstInfo)): foreach($cstInfo as $key=>$v): ?><div class="col-xs-6 col-md-2">
          <center>
          ...
          <h4><?php echo ($v["cstName"]); ?></h4></center>
          <p style=" color:#979797; width: 200px;"><?php echo ($v["eName"]); ?></p>
